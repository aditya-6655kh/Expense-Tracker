    ...
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950 px-4">
      ...
      <div className="glass-card rounded-2xl shadow-2xl w-full max-w-md p-8 sm:p-10">
        ...
        <div className="text-center mb-8 fade-up-1">
          <h2 className="text-2xl font-bold font-display text-[var(--color-text)] mb-1">Create your account</h2>
          <p className="text-[var(--color-text-muted)] text-sm">Start tracking your finances for free</p>
        </div>
        ...
        {/* Login link */}
        <p className="text-center text-sm text-[var(--color-text-muted)] fade-up-5">
          Already have an account?{" "}
          <Link to="/login" className="text-[var(--color-primary)] font-semibold hover:underline transition">
            Log in
          </Link>
        </p>
      </div>
